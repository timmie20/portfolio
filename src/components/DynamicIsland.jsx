...
const DynamicIsland = () => {
  ...
  return (
    <>
      {showComponent && (
        <div className="island_icons fixed inset-x-0 top-5 z-20 mx-auto flex w-[60%] max-w-[370px] items-center justify-center gap-4 rounded-xl border-white/30 border-opacity-30 bg-white/30 py-2 opacity-90 shadow-2xl backdrop-blur-xl md:gap-8">
          <svg
          ...
          <p
            className={`${current ? "active" : ""} text-sm font-medium md:text-base`}
          >
            projects
          </p>
